...
class AUTOPILOT():
    ...
    def takeoff(self,trgt_height = 1.0):  
        ...
        self.arm()
        self.channel_override(2,1550)       
        mode_resp = self.mode_service(custom_mode="2")
        print(mode_resp)
        # Takeoff
        ...
        mode_resp = self.mode_service(custom_mode="20")
        return mode_resp
    ...
    def channel_override(self,channel,pwm):
        rc_channel_list = OverrideRCIn()
        rc_channel_list.channels[channel] = pwm
        print(rc_channel_list)
        self.rc_override.publish(rc_channel_list)
